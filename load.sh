...
csvs-to-sqlite out/contributions.txt 527s.db --separator '|' --quoting 3 --fts org_name --fts ein --fts contributor_name
csvs-to-sqlite out/expenditures.txt 527s.db --separator '|' --quoting 3 --fts org_name --fts ein --fts recipient_name
rm -rf var
rm *.txt
rm fullData
rm -rf out
