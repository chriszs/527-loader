...
csvs-to-sqlite out/contributions.txt 527s.db --separator '|' --quoting 3 --fts org_name ein
csvs-to-sqlite out/expenditures.txt 527s.db --separator '|' --quoting 3 --fts org_name ein
rm -rf var
rm *.txt
rm fullData
rm -rf out
